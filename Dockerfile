...
RUN apt-get update -qq && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends meson ninja-build imagemagick libpq-dev build-essential pkg-config libglib2.0-dev libexpat1-dev && \
